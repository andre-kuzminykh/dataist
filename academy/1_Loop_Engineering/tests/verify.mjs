...
const PHRASES = {
  ...
  4: ['3. Harness Engineering', 'среду вокруг агента', 'АГЕНТ', 'Контекст', 'MCP', 'Разрешения',
      'Guardrails', 'Логи', 'без обёртки', 'умеет действовать'],
  5: ['4. Loop Engineering', 'проверяет вместо нас', 'Цель', 'Действие',
      'Фидбек', 'Память', 'не один запуск', 'повторяет цикл'],
  6: ['Из чего состоит', 'хороший loop', '6 элементов для управления', 'Автоматизация', 'когда запускать',
      'Правила', 'Навыки', 'Коннекторы', 'Агенты', 'Состояния', 'когда остановиться'],
