...
[FIGURE:1]
[CAPTION:Идея работы: навыки добавляют недостающий слой между моделью и обвязкой и улучшают результаты агента на нескольких бенчмарках.]
...
[FIGURE:2]
[CAPTION:Схема DisCo: сначала агент извлекает и проверяет операционное знание , потом подгружает только нужную ветку навыков во время решения задачи.]
...
[FIGURE:3]
[CAPTION:Устройство библиотеки навыков: более 5000 навыков из 1000 репозиториев и маршрутизатор , который помогает агенту подгружать только нужный фрагмент.]
