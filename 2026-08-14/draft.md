...
[FIGURE:0]
[CAPTION:Один агент, который улучшает только себя, быстро упирается в фиксированные ограничения; при коэволюции ограничения тоже начинают меняться.]
...
[FIGURE:1]
[CAPTION:Три стадии коэволюции: от адаптации между агентами к адаптации между агентами и средой, а затем к изменению самого механизма эволюции.]
...
[FIGURE:2]
[CAPTION:Ландшафт работ по коэволюции: больше всего исследований пока сосредоточено на связках «агент–агент» и «агент–среда», а мета-уровень только формируется.]
...
[FIGURE:3]
[CAPTION:Сводные данные из разных работ: коэволюция обычно помогает, но со временем прирост часто замедляется и выходит на плато.]
...
<!-- [FIGURE:0] Figure 1: Comparison between single-entity self-evolution and multi-component co-evolution. -->
<!-- [FIGURE:1] Figure 2: The progressive taxonomy of co-evolution, which reflects an expanding boundary of evolutionary freedom. -->
<!-- [FIGURE:2] Figure 3: Paper landscape of co-evolution in agentic systems. -->
<!-- [FIGURE:3] Figure 4: Cross-paper evidence for the effect, consistency, and convergence of co-evolution. See Appendix C for data selection and aggregation details. -->
