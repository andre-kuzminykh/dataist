...
[FIGURE:0]
[CAPTION:Переход от интеллекта модели к системному интеллекту: от промтов и контекста к обвязке, циклам и графовой инженерии.]
...
[FIGURE:1]
[CAPTION:Как способности модели превращаются в агента: промты, контекст, обвязка и циклы исполнения.]
...
[FIGURE:4]
[CAPTION:Организация задач: как цель раскладывается на подцели, зависимости и исполняемый пайплайн.]
...
[FIGURE:5]
[CAPTION:Координация агентов: способности, командная структура и потоки сообщений между агентами.]
...
[FIGURE:6]
[CAPTION:Управление состоянием во время выполнения: запись истории, поиск сбоев и восстановление системы.]
