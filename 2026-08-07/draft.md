...
<!-- [FIGURE:0] Figure 1: Order-level dynamics couple immediate liquidity pressure with delayed feedback.
New orders commit available cash before settlement, whereas abnormal outcomes surface later and affect store rating. -->
<!-- [FIGURE:1] Figure 2: Overview of MerchantBench.
...
<!-- [FIGURE:2] Figure 3: Real-world demand patterns and calibrated risk profiles across 98,843 products.
Whiskers span the 10th to 90th percentiles, and boxes show interquartile ranges. -->
<!-- [FIGURE:3] Figure 4: Final net asset distributions across three repeated runs for each configuration. -->
<!-- [FIGURE:4] Figure 5: Monthly Operational Coherence profiles for the Human baseline and all eight Hermes models.
Panels report effective window rate, environment tool calls, and monthly net profit. -->
<!-- [FIGURE:5] Figure 6: Monthly Product Sourcing across four representative models.
...
<!-- [FIGURE:6] Figure 11: Composition and calibrated distributions of the filtered data.
...
<!-- [FIGURE:7] Figure 12: Temporal demand patterns in the filtered data.
...
<!-- [FIGURE:8] Figure 13: Monthly Operational Coherence profiles for the Human baseline and each of the eight Hermes models.
Panels (a), (b), (c), and (d) report effective window rate, environment tool calls, month end active listings, and monthly net profit. -->
<!-- [FIGURE:9] Figure 14: Monthly Operational Coherence profiles for the Human baseline and each of the eight ReAct models.
Panels (a), (b), (c), and (d) report effective window rate, environment tool calls, month end active listings, and monthly net profit. -->
<!-- [FIGURE:10] Figure 15: Daily net asset curves for all eight models under ReAct over 365 simulated days. -->
<!-- [FIGURE:11] Figure 16: Daily net asset curves for all eight models under Hermes over 365 simulated days. -->
<!-- [FIGURE:12] Figure 17: Daily net asset curves for the Human and Rule-based baselines and all eight models over 365 simulated days. -->
<!-- [FIGURE:13] Figure 18: Daily net asset curves for all individual runs.
...
<!-- [FIGURE:14] Figure G : Monthly Product Sourcing across all eight models.
