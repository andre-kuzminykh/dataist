...
Этому и посвящена работа Дмитрия Жатухина: тому, **на что именно модели ссылаются**. Вместо вопроса «что ИИ сказал о бренде?» исследователь задаёт другой: «откуда ИИ это вообще взял?»
...
Исследование собрано из трёх наборов данных Rankfor.ИИ. В сумме это 128 брендов, 12 домашних рынков, 13 языков и 167 551 цитата с URL, то есть ссылки, где можно определить конкретный домен-источник.
