...
Авторы работы **EvolvingWorld** заходят ровно в эту боль. Они предлагают не просто еще один набор ролевых диалогов, а полноценную схему для долгой симуляции, где **персонажи и мир меняются вместе**. Не один отвечает, другой слушает, а затем все обнуляется. Нет — история движется, сцены сменяются, объекты в мире меняют состояние, а у героев накапливаются опыт, эмоции и последствия.
...
![Пример симуляции: из одного снимка истории система разворачивает новые сцены, где меняются и персонажи, и сам мир.](https://dataist.ai/2026-07-23/fig_0.jpg)
...
![Общая схема EvolvingWorld: от построения данных по книгам до симуляции сцен и оценки длинных траекторий.](https://dataist.ai/2026-07-23/fig_1.jpg)
...
![Сравнение EvolvingWorld и BookWorld по мере роста длины симуляции: новая схема лучше удерживает плавность развития профилей и связность сцен.](https://dataist.ai/2026-07-23/fig_2.jpg)
...
Главная мысль статьи проста и сильна: **для длинной симуляции мало хорошего диалога**. Нужны явные состояния персонажей, явные состояния мира, механизм накопления слабых сигналов, отдельное планирование сцен и оценка не по одной реплике, а по целой траектории.
